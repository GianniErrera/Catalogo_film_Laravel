...
Copiare la cartella del progetto all'imterno della cartella root del vostro server.

Salvare una copia del file .env.example rinominandola in .env, e modificare i campi DB_DATABASE, DB_USERNAME e DB_PASSWORD.

  ...
  <body class = "bg-grey-lightest">
        <div class = "container mx-auto m-4" >
            ...
            <form method = "POST" action = "/films/nuovo" enctype = "multipart/form-data">
              ...
              <div class="mb-4 border-grey border-4 rounded p-2">
              ...
              <label for="genere">oppure inserisci un genere nuovo</label>
                <textarea id = "genere_nuovo" name = "genere_nuovo" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded" placeholder='Genere'></textarea>
                <br>
                <br>
              ...
              <hr>
              <div class = "mb-4">
              <button type="submit" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline text-blue-lightest bg-blue hover:bg-blue-darkest">Inserisci</button>
                </div>
               @if ($errors->any())
